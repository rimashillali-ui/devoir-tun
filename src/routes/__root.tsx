    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          name: "Devoiratouna",
          alternateName: "دوفواراتنا",
          url: "https://devoiratona.lovable.app",
          description: "Plateforme éducative tunisienne gratuite — منصة تربوية تونسية مجانية",
          inLanguage: ["fr", "ar"],
          areaServed: { "@type": "Country", name: "Tunisia" },
          audience: { "@type": "EducationalAudience", educationalRole: "student" },
          potentialAction: {
            "@type": "SearchAction",
            target: "https://devoiratona.lovable.app/?q={search_term_string}",
